...
const ValueProposition: React.FC = () => {
  ...
  return (
    <section className="h-screen flex items-center bg-gradient-to-br from-green-50 via-white to-emerald-50 relative overflow-hidden" id="about">
          ...
          {valueProps.map((valueProp, index) => (
            <div 
              ...
              className="group relative bg-white/80 backdrop-blur-md rounded-xl p-6 
                ...
                hover:-translate-y-2 hover:rotate-1 overflow-hidden"
            >

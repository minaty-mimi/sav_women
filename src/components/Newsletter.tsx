...
const Newsletter: React.FC = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-neutral-900 via-green-900 to-green-800 text-white relative overflow-hidden py-32">
      ...
      <div className="absolute inset-0">
        ...
        {/* Removed animated elements for a cleaner look */}
        <div className="absolute top-3/4 right-1/4 w-6 h-6 bg-emerald-400/20 rounded-full animate-float-delayed"></div>
        <div className="absolute bottom-1/4 left-2/3 w-8 h-8 bg-teal-400/20 rounded-full animate-float-slow"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8">
          ...
          <p className="text-base md:text-lg mb-10 max-w-2xl mx-auto leading-relaxed text-neutral-300">
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 
              ...
              <div className="relative group">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-white/90 text-neutral-900 border-0 rounded-md h-10 text-sm placeholder:text-neutral-500 
                      focus:ring-1 focus:ring-green-600 shadow-sm transition-all duration-500 group-hover:shadow-md"
                    required
                  />
                </div>
              </div>
            ...
            <Button
              ...
              className="w-full bg-white hover:bg-neutral-100 text-green-800 font-medium text-sm 
                py-5 rounded-md shadow-sm hover:shadow-md transition-all duration-500 
